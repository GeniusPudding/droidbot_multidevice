.class public interface abstract Landroid441/support/v4/media/session/IMediaSession;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid441/support/v4/media/session/IMediaSession$Stub;
    }
.end annotation


# virtual methods
.method public abstract addQueueItem(Landroid441/support/v4/media/MediaDescriptionCompat;)V
...
.method public abstract addQueueItemAt(Landroid441/support/v4/media/MediaDescriptionCompat;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getMetadata()Landroid441/support/v4/media/MediaMetadataCompat;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getPlaybackState()Landroid441/support/v4/media/session/PlaybackStateCompat;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getVolumeAttributes()Landroid441/support/v4/media/session/ParcelableVolumeInfo;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract rate(Landroid441/support/v4/media/RatingCompat;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract rateWithExtras(Landroid441/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract registerCallbackListener(Landroid441/support/v4/media/session/IMediaControllerCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract removeQueueItem(Landroid441/support/v4/media/MediaDescriptionCompat;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid441/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract unregisterCallbackListener(Landroid441/support/v4/media/session/IMediaControllerCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
