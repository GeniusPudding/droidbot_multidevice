...
.method private final zzl(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v0, p1}, Landroid441/support/v4/content/ContextCompat;->getColor(Landroid/content/Context;I)I
...
.method final zzh(Landroid/os/Bundle;)Z
    ...
    .line 63
    iget-object v9, v0, Lcom/google/firebase/messaging/zza;->zzz:Landroid/content/Context;
    ...
    invoke-direct {v4, v12}, Landroid441/support/v4/app/NotificationCompat$Builder;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v8}, Landroid441/support/v4/app/NotificationCompat$Builder;->setSmallIcon(I)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    .line 174
    invoke-virtual {v4, v2}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-direct {v2}, Landroid441/support/v4/app/NotificationCompat$BigTextStyle;-><init>()V
    ...
    invoke-virtual {v4, v2}, Landroid441/support/v4/app/NotificationCompat$Builder;->setColor(I)Landroid441/support/v4/app/NotificationCompat$Builder;

    :cond_21
    if-eqz v7, :cond_22

    .line 181
    invoke-virtual {v4, v7}, Landroid441/support/v4/app/NotificationCompat$Builder;->setSound(Landroid/net/Uri;)Landroid441/support/v4/app/NotificationCompat$Builder;

    :cond_22
    if-eqz v11, :cond_23

    .line 183
    invoke-virtual {v4, v11}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentIntent(Landroid/app/PendingIntent;)Landroid441/support/v4/app/NotificationCompat$Builder;

    :cond_23
    if-eqz v9, :cond_24

    .line 185
    invoke-virtual {v4, v9}, Landroid441/support/v4/app/NotificationCompat$Builder;->setDeleteIntent(Landroid/app/PendingIntent;)Landroid441/support/v4/app/NotificationCompat$Builder;

    :cond_24
    if-eqz v10, :cond_25

    .line 187
    invoke-virtual {v4, v10}, Landroid441/support/v4/app/NotificationCompat$Builder;->setChannelId(Ljava/lang/String;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    .line 193
    :cond_26
    iget-object v4, v0, Lcom/google/firebase/messaging/zza;->zzz:Landroid/content/Context;
