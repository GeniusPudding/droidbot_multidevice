...
.field private zzyn:Landroid441/support/v4/util/SimpleArrayMap;
...
.field private zzyo:Landroid441/support/v4/util/SimpleArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid441/support/v4/util/SimpleArrayMap<",
            "Ljava/lang/String;",
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/android/gms/internal/ads/zzxn;Lcom/google/android/gms/internal/ads/zzang;Lcom/google/android/gms/ads/internal/zzw;)V
    ...
    new-instance p1, Landroid441/support/v4/util/SimpleArrayMap;

    invoke-direct {p1}, Landroid441/support/v4/util/SimpleArrayMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/ads/internal/zzak;->zzyo:Landroid441/support/v4/util/SimpleArrayMap;

    new-instance p1, Landroid441/support/v4/util/SimpleArrayMap;

    invoke-direct {p1}, Landroid441/support/v4/util/SimpleArrayMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/ads/internal/zzak;->zzyn:Landroid441/support/v4/util/SimpleArrayMap;
...
.method public final zza(Ljava/lang/String;Lcom/google/android/gms/internal/ads/zzrf;Lcom/google/android/gms/internal/ads/zzrc;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/ads/internal/zzak;->zzyo:Landroid441/support/v4/util/SimpleArrayMap;

    invoke-virtual {v0, p1, p2}, Landroid441/support/v4/util/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p2, p0, Lcom/google/android/gms/ads/internal/zzak;->zzyn:Landroid441/support/v4/util/SimpleArrayMap;

    invoke-virtual {p2, p1, p3}, Landroid441/support/v4/util/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final zzdh()Lcom/google/android/gms/internal/ads/zzkk;
    ...
    iget-object v10, v0, Lcom/google/android/gms/ads/internal/zzak;->zzyo:Landroid441/support/v4/util/SimpleArrayMap;

    iget-object v11, v0, Lcom/google/android/gms/ads/internal/zzak;->zzyn:Landroid441/support/v4/util/SimpleArrayMap;
