...
.method final zze(Landroid/os/Bundle;)Z
    ...
    :cond_19
    new-instance v6, Landroid441/support/v4/app/NotificationCompat$Builder;

    iget-object v7, p0, Lcom/google/android/gms/gcm/zzd;->zzk:Landroid/content/Context;

    invoke-direct {v6, v7}, Landroid441/support/v4/app/NotificationCompat$Builder;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v9}, Landroid441/support/v4/app/NotificationCompat$Builder;->setAutoCancel(Z)Landroid441/support/v4/app/NotificationCompat$Builder;

    move-result-object v6

    invoke-virtual {v6, v4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setSmallIcon(I)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v4, v0}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v4, v1}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v4, v0}, Landroid441/support/v4/app/NotificationCompat$Builder;->setColor(I)Landroid441/support/v4/app/NotificationCompat$Builder;

    :cond_1c
    if-eqz v3, :cond_1d

    invoke-virtual {v4, v3}, Landroid441/support/v4/app/NotificationCompat$Builder;->setSound(Landroid/net/Uri;)Landroid441/support/v4/app/NotificationCompat$Builder;
