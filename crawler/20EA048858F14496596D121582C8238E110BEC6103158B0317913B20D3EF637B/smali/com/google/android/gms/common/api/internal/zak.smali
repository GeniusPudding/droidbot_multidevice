...
# instance fields
.field private final zaay:Landroid441/support/v4/util/ArrayMap;
...
.field private final zada:Landroid441/support/v4/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid441/support/v4/util/ArrayMap<",
            "Lcom/google/android/gms/common/api/internal/zai<",
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/zak;->zada:Landroid441/support/v4/util/ArrayMap;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/zak;->zaay:Landroid441/support/v4/util/ArrayMap;
    ...
    .line 7
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/zak;->zaay:Landroid441/support/v4/util/ArrayMap;
    ...
    invoke-virtual {v1, v0, v2}, Landroid441/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    .line 9
    :cond_0
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/zak;->zaay:Landroid441/support/v4/util/ArrayMap;

    invoke-virtual {p1}, Landroid441/support/v4/util/ArrayMap;->keySet()Ljava/util/Set;
...
.method public final zaa(Lcom/google/android/gms/common/api/internal/zai;Lcom/google/android/gms/common/ConnectionResult;Ljava/lang/String;)V
    ...
    .line 13
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/zak;->zaay:Landroid441/support/v4/util/ArrayMap;

    invoke-virtual {v0, p1, p2}, Landroid441/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 14
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/zak;->zada:Landroid441/support/v4/util/ArrayMap;

    invoke-virtual {v0, p1, p3}, Landroid441/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Lcom/google/android/gms/common/api/internal/zak;->zaay:Landroid441/support/v4/util/ArrayMap;

    invoke-direct {p1, p2}, Lcom/google/android/gms/common/api/AvailabilityException;-><init>(Landroid441/support/v4/util/ArrayMap;)V
    ...
    iget-object p2, p0, Lcom/google/android/gms/common/api/internal/zak;->zada:Landroid441/support/v4/util/ArrayMap;
