...
.field private zaoe:Landroid441/support/v4/util/ArraySet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid441/support/v4/util/ArraySet<",
...
.method public final addAllRequiredScopes(Ljava/util/Collection;)Lcom/google/android/gms/common/internal/ClientSettings$Builder;
    ...
    .line 10
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings$Builder;->zaoe:Landroid441/support/v4/util/ArraySet;

    if-nez v0, :cond_0

    .line 11
    new-instance v0, Landroid441/support/v4/util/ArraySet;

    invoke-direct {v0}, Landroid441/support/v4/util/ArraySet;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings$Builder;->zaoe:Landroid441/support/v4/util/ArraySet;

    .line 12
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings$Builder;->zaoe:Landroid441/support/v4/util/ArraySet;

    invoke-virtual {v0, p1}, Landroid441/support/v4/util/ArraySet;->addAll(Ljava/util/Collection;)Z
...
.method public final build()Lcom/google/android/gms/common/internal/ClientSettings;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/internal/ClientSettings$Builder;->zaoe:Landroid441/support/v4/util/ArraySet;
