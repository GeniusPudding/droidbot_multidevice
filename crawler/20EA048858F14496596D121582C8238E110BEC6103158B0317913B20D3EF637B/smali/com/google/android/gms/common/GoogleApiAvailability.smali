...
.method static zaa(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 124
    instance-of v0, p0, Landroid441/support/v4/app/FragmentActivity;

    if-eqz v0, :cond_0

    .line 126
    check-cast p0, Landroid441/support/v4/app/FragmentActivity;
    ...
    .line 130
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid441/support/v4/app/FragmentManager;Ljava/lang/String;)V
...
.method private final zaa(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 148
    new-instance v3, Landroid441/support/v4/app/NotificationCompat$Builder;

    invoke-direct {v3, p1}, Landroid441/support/v4/app/NotificationCompat$Builder;-><init>(Landroid/content/Context;)V

    const/4 v4, 0x1

    .line 149
    invoke-virtual {v3, v4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setLocalOnly(Z)Landroid441/support/v4/app/NotificationCompat$Builder;

    move-result-object v3

    .line 150
    invoke-virtual {v3, v4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setAutoCancel(Z)Landroid441/support/v4/app/NotificationCompat$Builder;

    move-result-object v3

    .line 151
    invoke-virtual {v3, p3}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$Builder;

    move-result-object p3

    new-instance v3, Landroid441/support/v4/app/NotificationCompat$BigTextStyle;

    invoke-direct {v3}, Landroid441/support/v4/app/NotificationCompat$BigTextStyle;-><init>()V

    .line 152
    invoke-virtual {v3, v0}, Landroid441/support/v4/app/NotificationCompat$BigTextStyle;->bigText(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$BigTextStyle;

    move-result-object v3

    invoke-virtual {p3, v3}, Landroid441/support/v4/app/NotificationCompat$Builder;->setStyle(Landroid441/support/v4/app/NotificationCompat$Style;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p3, v0}, Landroid441/support/v4/app/NotificationCompat$Builder;->setSmallIcon(I)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    .line 157
    invoke-virtual {v0, v3}, Landroid441/support/v4/app/NotificationCompat$Builder;->setPriority(I)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    .line 161
    invoke-virtual {p3, v0, v1, p4}, Landroid441/support/v4/app/NotificationCompat$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid441/support/v4/app/NotificationCompat$Builder;

    goto :goto_0

    .line 162
    :cond_3
    invoke-virtual {p3, p4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentIntent(Landroid/app/PendingIntent;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    .line 164
    invoke-virtual {p3, v3}, Landroid441/support/v4/app/NotificationCompat$Builder;->setSmallIcon(I)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v3, v1}, Landroid441/support/v4/app/NotificationCompat$Builder;->setTicker(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v1, v3, v4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setWhen(J)Landroid441/support/v4/app/NotificationCompat$Builder;

    move-result-object v1

    .line 167
    invoke-virtual {v1, p4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentIntent(Landroid/app/PendingIntent;)Landroid441/support/v4/app/NotificationCompat$Builder;

    move-result-object p4

    .line 168
    invoke-virtual {p4, v0}, Landroid441/support/v4/app/NotificationCompat$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid441/support/v4/app/NotificationCompat$Builder;
    ...
    :cond_6
    :goto_1
    invoke-virtual {p3, p4}, Landroid441/support/v4/app/NotificationCompat$Builder;->setChannelId(Ljava/lang/String;)Landroid441/support/v4/app/NotificationCompat$Builder;

    .line 188
    :cond_7
    invoke-virtual {p3}, Landroid441/support/v4/app/NotificationCompat$Builder;->build()Landroid/app/Notification;
